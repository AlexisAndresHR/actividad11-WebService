...
INSERT INTO clientes (nombre, apellido_paterno, apellido_materno, telefono, email) VALUES 
    ('Elsa', 'Ramirez', 'Martinez', '7751355784', 'elsy-7@gmail.com'),
    ('Aranxa Itati', 'Hernandez', 'Ramirez', '7751374275', 'ara-hr02@gmail.com'),
    ('Juan Andres', 'Hernandez', 'Zapata', '7751055669', 'hernandez.juanandres@gmail.com');
...
CREATE USER 'aahr'@'localhost' IDENTIFIED BY 'aahr.2019';
GRANT ALL PRIVILEGES ON act11_webservice_aahr.* TO 'aahr'@'localhost';
FLUSH PRIVILEGES;
